        ...
        switch($values[$options['sending_method']]){
            ...
            case 'gmail':
                ...
                $content_email.=str_replace(
                        array('[link]','[/link]'),
                        array('<a href="http://mailbard.com/knowledgebase/send-with-smtp-when-using-a-professional-sending-provider/?utm_source=wpadmin&utm_campaign=test_email_result" target="_blank" title="SendGrid partnership">','</a>'),
